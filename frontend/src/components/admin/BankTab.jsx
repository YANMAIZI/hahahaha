...
const SETTINGS = [
  { key: "rtp_target", label: "RTP (доля возврата игрокам)", hint: "Комиссия казино = 100% − RTP. Заложена прямо в шанс: при ставке 50% от цены скина игрок видит и получает шанс 45% (при RTP 90%). Никаких скрытых отмен выигрышей.", min: 75, max: 100, fmt: (v) => `${v}% · комиссия ${100 - v}%`, to: (v) => v / 100, from: (v) => Math.round(v * 100) },
];
